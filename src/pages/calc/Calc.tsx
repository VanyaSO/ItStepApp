...
import MemoryButton from './components/MemoryButton.tsx';
    ...
    return (
      <View style={styles.calcContainer}>
        ...
        <View style={styles.memoryButtonRow}>
          <MemoryButton title="MC" action={onMemPress} />
          <MemoryButton title="MR" action={onMemPress} />
          <MemoryButton title="M+" action={onMemPress}  isLight />
          <MemoryButton title={'M\u2212'} action={onMemPress} isLight />
          <MemoryButton title="MS" action={onMemPress} isLight />
          <MemoryButton title={'M\u02C7'} action={onMemPress} />
        </View>
    ...
    return (
      <View style={styles.calcContainer}>
        ...
        <View style={styles.memoryButtonRow}>
          <MemoryButton title="MC" action={onMemPress} />
          <MemoryButton title="MR" action={onMemPress} />
          <MemoryButton title="M+" action={onMemPress} />
          <MemoryButton title={'M\u2212'} action={onMemPress} />
          <MemoryButton title="MS" action={onMemPress} />
          <MemoryButton title={'M\u02C7'} action={onMemPress} />
        </View>
        <View style={styles.calcButtonRow}>
          <CalcButton title="%" action={onOperationPress} />
